...
const outputTypes = [
  { file: `./dist/button/cjs/${fileName}.js`, format: 'cjs', minify: false },
  { file: `./dist/button/cjs/${fileName}.min.js`, format: 'cjs', minify: true },
  { file: `./dist/button/es/${fileName}.mjs`, format: 'es', minify: false },
