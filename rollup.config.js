...
const outputTypes = [
  { file: `dist/cjs/${fileName}.js`, format: 'cjs', minify: false },
  { file: `dist/cjs/${fileName}.min.js`, format: 'cjs', minify: true },
  { file: `dist/es/${fileName}.mjs`, format: 'es', minify: false },
